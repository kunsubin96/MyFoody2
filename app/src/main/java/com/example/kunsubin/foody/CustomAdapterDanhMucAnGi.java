...
public class CustomAdapterDanhMucAnGi extends BaseAdapter{
    String [] result;
    Context context;
    int [] imageId;
    private static LayoutInflater inflater=null;
    public CustomAdapterDanhMucAnGi(MainActivity mainActivity, String[] prgmNameList, int[] prgmImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == StaticData.getSelectedDanhMucAnGi()) {
