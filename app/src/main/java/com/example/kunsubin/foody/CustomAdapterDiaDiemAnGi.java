...
public class CustomAdapterDiaDiemAnGi extends BaseAdapter {
    Context context;
    List<QuanHuyen> listQuanHuyen;
    private static LayoutInflater inflater=null;
    public CustomAdapterDiaDiemAnGi(MainActivity mainActivity, List<QuanHuyen> listQuanHuyen) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == StaticData.getSelectedDiaDiemAnGi()) {
